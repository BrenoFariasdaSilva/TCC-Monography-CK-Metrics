...
\title{Abordagem para seleção de exemplos de código de sistemas distribuídos para a criação de exemplos trabalhados de engenharia de software}
...
\PalavraChaveD{Engenharia de Software}%% Palavra-chave D
\PalavraChaveE{Sistemas Distribu\'idos}%% Palavra-chave E
...
\KeywordC{Worked Examples}%% Keyword C
\KeywordD{Software Engineering}%% Keyword D
\KeywordE{Distributed Systems}%% Keyword E
