...
\titleen{CK Metrics as a Tool for Learning Code Evolution and Best Practices in the Classroom} % Título traduzido para inglês
...
\evalboardmember{Igor Wiese}{Doutorado em Ciência da Computação}{Universidade Tecnológica Federal do Paraná - Campo Mourão}
