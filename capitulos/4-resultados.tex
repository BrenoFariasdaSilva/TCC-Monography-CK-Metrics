...
% Escrever sobre a refatoração do tipo Pull-up method encontrada no arquivo quorum follower do ZooKeeper, onde também é encontrado tendência de queda nas métricas.
