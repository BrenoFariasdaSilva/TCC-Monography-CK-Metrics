...
\begin{itemize}
    ...
    \item Contribuir para a formação e boas práticas de código em \gls{es}, compartilhando as descobertas e \textit{insights} obtidos ao longo da pesquisa. OBS: Ir para a sessão de contribuições.
\end{itemize}
...
\begin{itemize}
    ...
    \item OBS: Tem um portanto repetido, um perto do outro.
    \item OBS: Muita repetição sobre a formação dos profissionais mais capacitados.
\end{itemize}
