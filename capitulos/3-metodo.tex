...
4 - Escrita e publicação de um artigo resumido & & x & x & & & \\
5 - Seleção de exemplos & & & & x & x & x \\
6 - Avaliação da utilidade educacional & & & & x & x & x \\
7 - Escrita e publicação de um artigo resumido & & & & & x & x
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \item Escrita e publicação de um artigo resumido sobre o projeto e as metodologias utilizadas até o momento.
    ...
    \item Escrita e publicação de um artigo resumido sobre os resultados obtidos até o momento, destacando descobertas e contribuições.
