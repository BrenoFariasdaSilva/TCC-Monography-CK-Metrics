...
\sigla{loc}{LOC}{\textit{Lines of Code}}
...
\sigla{cap}{CAP}{\textit{Consistency, Availability and Partition Tolerance}}
\sigla{sae}{SAE}{\textit{Security Attack Explorer}}
\sigla{vcs}{VCS}{\textit{Version Control System}}
\sigla{tcc1}{TCC1}{Trabalho de Conclusão de Curso 1}
\sigla{tcc2}{TCC2}{Trabalho de Conclusão de Curso 2}
\sigla{cve}{CVE}{\textit{Common Vulnerabilities and Exposures}}
